...
class Test_ArrayAccess_Aware extends TestCase {

	/** @testdox It should be possible to set a value using array syntax when using the ArrayAccess_Aware trait*/
	...
	/** @testdox It should be possible to get a value from an index using array syntax when using the ArrayAccess_Aware trait*/
	...
	/** @testdox It should be possible to unset a value from an index using array syntax when using the ArrayAccess_Aware trait*/
	...
	/** @testdox It should be possible to check an index exists using array syntax when using the ArrayAccess_Aware trait*/
